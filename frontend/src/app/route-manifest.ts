...
export const routeManifest: RouteManifestEntry[] = [
  ...
  { allowedRoles: ADMIN_ROLES, description: 'NEW-LGL-3 — tenant-defined custom roles (Squad Lead, Tribe Lead, IT Service Owner). Built-in PlatformRole values are read-only. Reached via the Admin → Governance tab; not surfaced directly in the v2 sidebar.', flag: 'dsRefresh', group: 'admin-governance', navVisible: false, path: '/admin/governance/roles', title: 'Custom Roles' },
