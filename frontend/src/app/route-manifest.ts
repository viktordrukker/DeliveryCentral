...
export const routeManifest: RouteManifestEntry[] = [
  ...
  { allowedRoles: ADMIN_ROLES, description: 'F-5.4 / D-159 — override the role list behind each named RBAC preset (EXEC_ROLES, HR_GOVERNANCE_ROLES, etc.). Flag-gated by adminRolePermissionUI (default OFF).', group: 'admin', navVisible: false, path: '/admin/access-policies/edit', title: 'Role Permissions' },
