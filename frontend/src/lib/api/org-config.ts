...
export async function fetchOrgConfig(): Promise<OrgConfigDto> {
  return httpGet<OrgConfigDto>(`/admin/organization-config`);
}

export async function updateOrgConfig(patch: UpdateOrgConfigDto): Promise<OrgConfigDto> {
  return httpPatch<OrgConfigDto, UpdateOrgConfigDto>(`/admin/organization-config`, patch);
}

export async function resetOrgConfig(): Promise<OrgConfigDto> {
  return httpPost<OrgConfigDto, Record<string, never>>(`/admin/organization-config/reset`, {});
}
