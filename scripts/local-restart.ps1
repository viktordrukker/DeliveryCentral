...
$logFile = Join-Path $logsDirectory ("local-restart-{0}.log" -f (Get-Date -Format 'yyyyMMdd-HHmmss'))

& powershell -ExecutionPolicy Bypass -File $scriptPath restart -LogFilePath $logFile
