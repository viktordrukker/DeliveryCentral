...
$logFile = Join-Path $logsDirectory ("local-stop-{0}.log" -f (Get-Date -Format 'yyyyMMdd-HHmmss'))

& powershell -ExecutionPolicy Bypass -File $scriptPath stop -LogFilePath $logFile
