...
export const WEBHOOK_EVENT_TYPES = [
  ...
  'assignment.onboarding_approved',
  'assignment.onboarding_rejected',
...
export const WEBHOOK_EVENT_DESCRIPTIONS: Record<WebhookEventType, string> = {
  ...
  'assignment.onboarding_approved': 'The onboarding approval gate was approved — assignment may transition ONBOARDING → ASSIGNED.',
  'assignment.onboarding_rejected': 'The onboarding approval gate was rejected — assignment cannot transition to ASSIGNED until re-opened.',
