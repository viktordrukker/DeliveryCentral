...
@Module({
  imports: [CaseManagementModule, FinancialGovernanceModule, LeaveRequestsModule, OrganizationModule, PlatformSettingsModule, ProjectPositionsModule, ProjectRegistryModule, SkillsModule, TimesheetsModule, WorkEvidenceModule],
