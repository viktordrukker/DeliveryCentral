...
- [ ] **20c-11** Fix dangerous `as unknown as` type assertions — 12+ instances in cases.controller, hr-dashboard-query, InteractiveOrgChart, SettingsPage. Create proper TypeScript interfaces — BE/FE · Severity: Medium _partial: 46/121 sites closed. F-9.3 (7 Decimal), F-31 (12 help-service GetPayload), F-33 (10 rate-card client casts), F-35 (11 translator payload casts), F-37 (6 decide-budget-change client casts). ~84 sites remain across in-memory-staffing-request (10), staffing-proposal-slate (5), responsibility-rules-admin (5), and other services._
