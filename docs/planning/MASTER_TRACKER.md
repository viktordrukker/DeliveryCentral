...
- [ ] **D-103** — [GAP] Schema-wide actor-audit gap — 0/105 models have `createdById`/`updatedById`. Decide: denormalize on rows (cost M) or formalize "use AuditLog joins" with documented patterns + lint rule. _partial: 20/105 models. Rounds 1-10: F-10.3..F-36 (16), F-38 (NotificationTemplate + ResponsibilityRule), F-40 (OvertimePolicy + PlatformSetting). Remaining ~85._ — `data-quality-audit.md` Part 1 finding 1
