...
- [ ] **D-103** — [GAP] Schema-wide actor-audit gap — 0/105 models have `createdById`/`updatedById`. Decide: denormalize on rows (cost M) or formalize "use AuditLog joins" with documented patterns + lint rule. _partial: 22/105 models. Rounds 1-11: F-10.3..F-40 (20), F-42 (Client + Vendor — sales/finance aggregates). Remaining ~83._ — `data-quality-audit.md` Part 1 finding 1
