...
- [ ] **20c-11** Fix dangerous `as unknown as` type assertions — 12+ instances in cases.controller, hr-dashboard-query, InteractiveOrgChart, SettingsPage. Create proper TypeScript interfaces — BE/FE · Severity: Medium _partial: 55/121 sites closed. F-9.3 (7 Decimal), F-31 (12), F-33 (10), F-35 (11), F-37 (6), F-39 (4), F-41 (5 responsibility-rules-admin client casts). ~75 sites remain across in-memory-staffing-request (10), request-budget-change (5), decide-person-release (5), and others._
