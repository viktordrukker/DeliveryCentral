...
- [ ] **20c-11** Fix dangerous `as unknown as` type assertions — 12+ instances in cases.controller, hr-dashboard-query, InteractiveOrgChart, SettingsPage. Create proper TypeScript interfaces — BE/FE · Severity: Medium _partial: 65/121 sites closed. F-9.3 (7), F-31 (12), F-33 (10), F-35 (11), F-37 (6), F-39 (4), F-41 (5), F-43 (5), F-45 (5 decide-person-release client casts — also surfaced + fixed a pre-existing bug where the cast hid `Person.orgUnitId` not existing on schema; org-unit scope routing was already broken and was never reaching this resolver). ~65 sites remain._
