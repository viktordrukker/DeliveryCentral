...
| Phase V2 | DS Redesign Operational Cutover | V2-A..V2-H + V2-X | 🔄 In Progress (2026-05-26): **ds-conformance 39→0** + ratchet wired (Husky + CI) + DS Tabs atom shipped + **V2-B.4 SparklineDs CLOSED** + **V2-B.6 VarianceBar CLOSED** + **12 V2-A surfaces CLOSED/partial** (V2-A.1 #371 · V2-A.4 #373 · V2-A.5 #370 · V2-A.6 #370 · V2-A.7 #369 · V2-A.8 #372 · V2-A.10 #375 · V2-A.12 partial #377 · V2-A.14 #360 · V2-A.15 partial #391 · V2-A.17 #389 · V2-A.18 accepted) + **V2-F token cleanup in progress** (baseline 335→247 across 13 slices, PRs #395/#396/#401–#404/#406–#409/#411–#413). **~46/132 items done (~35%)**. PRs #342–#413 merged or in flight (68+). Atom adoption: Money 2→13, Pct 2→129+, Avatar 6→28, Timeline (DS) 4→5, VarianceBar 1→2. Next: V2-A.3 Plan tab Gantt (depends on workstream BE), continued V2-F long-tail token retirement, continued long-tail atom sweep. |
...
- [-] **V2-F.7** Long-tail (~116 violations across remaining ~56 files) — sweep file-by-file, ratcheting baseline downward. _2026-05-28 in-progress: baseline ratcheted **335 → 247** across 13 slices (PRs #395/#396/#401–#404/#406–#409/#411–#413). Highest-yield targets: (a) multi-color recharts palettes + status maps → `--color-chart-1..8` / `--color-status-*`; (b) the cross-file `var(--color-X, #hex)` fallback-strip via `sed` — applied only to tokens defined in design-tokens.ts (chart-5, status-active/danger/warning, surface-alt), cleared 24 entries across 7 files in PRs #412/#413. Grey/white text → `--color-text`/`--color-text-muted`/`--color-text-subtle`/`--color-surface`; track/grid bg → `--color-border`. Deferred: ImpersonationBanner always-orange overlay (needs dedicated always-light token); undefined-token fallbacks (error/primary/success/warning/text-tertiary/on-status — their hex is load-bearing until tokens are added). Pattern: surgical/line-based baseline-entry removal (avoid python json.dump — escapes emoji/em-dash)._ — FE
