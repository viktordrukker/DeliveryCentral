...
| Phase V2 | DS Redesign Operational Cutover | V2-A..V2-H + V2-X | 🔄 In Progress (2026-05-26): **ds-conformance 39→0** + ratchet wired (Husky + CI) + DS Tabs atom shipped + **V2-B.4 SparklineDs CLOSED** + **V2-B.6 VarianceBar CLOSED** + **12 V2-A surfaces CLOSED/partial** (V2-A.1 #371 · V2-A.4 #373 · V2-A.5 #370 · V2-A.6 #370 · V2-A.7 #369 · V2-A.8 #372 · V2-A.10 #375 · V2-A.12 partial #377 · V2-A.14 #360 · V2-A.15 partial #391 · V2-A.17 #389 · V2-A.18 accepted) + **V2-F token cleanup in progress** (baseline 335→312 across 6 slices, PRs #395/#396/#401/#402/#403/#404). **~46/132 items done (~35%)**. PRs #342–#404 merged or in flight (60+). Atom adoption: Money 2→13, Pct 2→129+, Avatar 6→28, Timeline (DS) 4→5, VarianceBar 1→2. Next: V2-A.3 Plan tab Gantt (depends on workstream BE), continued V2-F long-tail token retirement, continued long-tail atom sweep. |
...
- [-] **V2-F.7** Long-tail (~187 violations across remaining ~70 files) — sweep file-by-file, ratcheting baseline downward. _2026-05-26 in-progress: baseline ratcheted **335 → 312** across 6 slices. PRs #395/#396 (App demo banner, setup-gate, StatusBadge score fill, AppShell demo button), #401 (WorkflowStages STATUS_TONE text ×3, Calendar selected-day fallback drop), #402 (AuditTimeline timestamp/empty-state, ProjectTimeline label, ExportCentre description), #403 (AuditTimeline summary, ReportBuilder Columns/Filters/type/meta, AccountSettings helper), #404 (BudgetBurnDownChart lines, WorkforceOverviewChart grid fallback, UtilizationPage track). Mapping conventions: grey text → `--color-text`/`--color-text-muted`/`--color-text-subtle`; white-on-color → `--color-surface`; chart strokes → `--color-chart-*`; track/grid bg → `--color-border`. Deferred: ImpersonationBanner always-orange overlay (needs dedicated always-light token). Pattern: surgical baseline-entry removal (avoid python json.dump — escapes emoji/em-dash)._ — FE
