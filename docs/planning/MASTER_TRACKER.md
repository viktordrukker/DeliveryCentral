...
| Phase WO | Assignment Workflow Overhaul (slate, IN_REVIEW, SLA, admin-configurable thresholds) | — | 🔄 48/49 items — WO-1..WO-3 ✅, WO-4 14/15 (WO-4.12 open; its target StaffingRequestDetailPage was deleted by V2 PR 17b), WO-5 ✅ (5.7/5.8 closed 2026-05-15 audit); WO-6 migration+cutover pending (no items listed) (2026-06-11) |
...
| Phase DS | Design System Standardization (atoms / molecules / surfaces / feature blocks / grammars + mobile + theming + UX-contract gating) | — | 🔄 42 done / 8 deferred / 2 open (DS-5-6 remaining-page sweep, DS-5-7 100% grammar conformance) (2026-06-11). Plan: `~/.claude/plans/this-is-a-pure-idempotent-cray.md`. |
