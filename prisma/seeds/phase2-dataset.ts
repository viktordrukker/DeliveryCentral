...
export const phase2Assignments = [
  ...
  { id: '36666666-0000-0000-2222-000000000001', personId: '11111111-1111-1111-1111-111111111008', projectId: '33333333-3333-3333-3333-333333333002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', assignmentCode: 'ASN-101', staffingRole: 'Lead Engineer',       status: 'ACTIVE',    allocationPercent: '80.00', requestedAt: new Date('2025-10-01T00:00:00Z'), approvedAt: new Date('2025-10-03T00:00:00Z'), validFrom: new Date('2025-10-15T00:00:00Z') },
  { id: '36666666-0000-0000-2222-000000000002', personId: '11111111-1111-1111-1111-111111111010', projectId: '33333333-3333-3333-3333-333333333002', requestedByPersonId: '11111111-1111-1111-1111-111111111005', assignmentCode: 'ASN-102', staffingRole: 'Program Manager',     status: 'ACTIVE',    allocationPercent: '40.00', requestedAt: new Date('2025-09-15T00:00:00Z'), approvedAt: new Date('2025-09-17T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z') },

  // PRJ-102 Atlas — Ethan Brooks 40% (overallocated: 80+40=120%), Tyler Grant 100%
  { id: '36666666-0000-0000-2222-000000000003', personId: '11111111-1111-1111-1111-111111111008', projectId: '33333333-3333-3333-3333-333333333003', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-103', staffingRole: 'Lead Engineer',       status: 'ACTIVE',    allocationPercent: '40.00', requestedAt: new Date('2025-12-01T00:00:00Z'), approvedAt: new Date('2025-12-03T00:00:00Z'), validFrom: new Date('2026-01-01T00:00:00Z'), validTo: new Date('2026-04-30T00:00:00Z') },
  { id: '36666666-0000-0000-2222-000000000004', personId: '11111111-1111-1111-2222-000000000005', projectId: '33333333-3333-3333-3333-333333333003', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-104', staffingRole: 'Frontend Engineer',   status: 'ACTIVE',    allocationPercent: '100.00', requestedAt: new Date('2025-12-01T00:00:00Z'), approvedAt: new Date('2025-12-03T00:00:00Z'), validFrom: new Date('2026-01-01T00:00:00Z'), validTo: new Date('2026-04-30T00:00:00Z') },

  // PRJ-103 Beacon — Mia Lopez active
  { id: '36666666-0000-0000-2222-000000000005', personId: '11111111-1111-1111-1111-111111111009', projectId: '33333333-3333-3333-3333-333333333004', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-105', staffingRole: 'Mobile Engineer',     status: 'ACTIVE',    allocationPercent: '100.00', requestedAt: new Date('2025-11-01T00:00:00Z'), approvedAt: new Date('2025-11-03T00:00:00Z'), validFrom: new Date('2025-11-15T00:00:00Z') },
  { id: '36666666-0000-0000-2222-000000000006', personId: '11111111-1111-1111-2222-000000000006', projectId: '33333333-3333-3333-3333-333333333004', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-106', staffingRole: 'Backend Engineer',    status: 'ACTIVE',    allocationPercent: '80.00', requestedAt: new Date('2025-11-01T00:00:00Z'), approvedAt: new Date('2025-11-03T00:00:00Z'), validFrom: new Date('2025-11-15T00:00:00Z') },

  // PRJ-104 Nova — Rin Yamamoto active
  { id: '36666666-0000-0000-2222-000000000007', personId: '11111111-1111-1111-2222-000000000009', projectId: '33333333-3333-3333-3333-333333333005', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-107', staffingRole: 'Analytics Engineer',  status: 'ACTIVE',    allocationPercent: '60.00', requestedAt: new Date('2025-10-01T00:00:00Z'), approvedAt: new Date('2025-10-03T00:00:00Z'), validFrom: new Date('2025-10-15T00:00:00Z'), validTo: new Date('2026-04-30T00:00:00Z') },

  // PRJ-105 Polaris — Harper Ali active (60%), Kwame Mensah active
  { id: '36666666-0000-0000-2222-000000000008', personId: '11111111-1111-1111-1111-111111111011', projectId: '33333333-3333-3333-3333-333333333006', requestedByPersonId: '11111111-1111-1111-1111-111111111007', assignmentCode: 'ASN-108', staffingRole: 'Security Analyst',    status: 'ACTIVE',    allocationPercent: '60.00', requestedAt: new Date('2025-12-01T00:00:00Z'), approvedAt: new Date('2025-12-03T00:00:00Z'), validFrom: new Date('2026-01-01T00:00:00Z') },
  { id: '36666666-0000-0000-2222-000000000009', personId: '11111111-1111-1111-2222-000000000010', projectId: '33333333-3333-3333-3333-333333333006', requestedByPersonId: '11111111-1111-1111-1111-111111111007', assignmentCode: 'ASN-109', staffingRole: 'Data Analyst',         status: 'APPROVED',  allocationPercent: '40.00', requestedAt: new Date('2026-01-15T00:00:00Z'), approvedAt: new Date('2026-01-17T00:00:00Z'), validFrom: new Date('2026-02-01T00:00:00Z') },

  // PRJ-107 Jupiter — only a REQUESTED assignment (no APPROVED/ACTIVE) → staffing gap
  { id: '36666666-0000-0000-2222-000000000010', personId: '11111111-1111-1111-2222-000000000016', projectId: '33333333-3333-3333-2222-000000000002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', assignmentCode: 'ASN-110', staffingRole: 'Project Coordinator',  status: 'REQUESTED', allocationPercent: '50.00', requestedAt: new Date('2026-03-10T00:00:00Z'), validFrom: new Date('2026-04-15T00:00:00Z') },
  ...
  { id: '36666666-0000-0000-2222-000000000012', personId: '11111111-1111-1111-2222-000000000015', projectId: '33333333-3333-3333-2222-000000000003', requestedByPersonId: '11111111-1111-1111-1111-111111111005', assignmentCode: 'ASN-112', staffingRole: 'Senior Program Manager', status: 'ENDED',   allocationPercent: '50.00', requestedAt: new Date('2025-09-15T00:00:00Z'), approvedAt: new Date('2025-09-17T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z'), validTo: new Date('2026-01-31T00:00:00Z') },

  // PRJ-100 Bench — Consulting team on bench assignments (approved)
  { id: '36666666-0000-0000-2222-000000000013', personId: '11111111-1111-1111-2222-000000000013', projectId: '33333333-3333-3333-3333-333333333001', requestedByPersonId: '11111111-1111-1111-1111-111111111005', assignmentCode: 'ASN-113', staffingRole: 'Bench Consultant',    status: 'ACTIVE',    allocationPercent: '100.00', requestedAt: new Date('2026-02-01T00:00:00Z'), approvedAt: new Date('2026-02-03T00:00:00Z'), validFrom: new Date('2026-02-15T00:00:00Z') },
  { id: '36666666-0000-0000-2222-000000000014', personId: '11111111-1111-1111-2222-000000000014', projectId: '33333333-3333-3333-3333-333333333001', requestedByPersonId: '11111111-1111-1111-1111-111111111005', assignmentCode: 'ASN-114', staffingRole: 'Bench Consultant',    status: 'APPROVED',  allocationPercent: '100.00', requestedAt: new Date('2026-02-01T00:00:00Z'), approvedAt: new Date('2026-02-03T00:00:00Z'), validFrom: new Date('2026-03-01T00:00:00Z') },

  // PRJ-101 — past ended assignment for date-range filter test (JTBD-DM4)
  { id: '36666666-0000-0000-2222-000000000015', personId: '11111111-1111-1111-2222-000000000018', projectId: '33333333-3333-3333-3333-333333333002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', assignmentCode: 'ASN-115', staffingRole: 'Backend Engineer',    status: 'ENDED',     allocationPercent: '100.00', requestedAt: new Date('2025-05-01T00:00:00Z'), approvedAt: new Date('2025-05-03T00:00:00Z'), validFrom: new Date('2025-06-01T00:00:00Z'), validTo: new Date('2026-01-31T00:00:00Z') },
  // Victor's assignment ended when he was terminated
  { id: '36666666-0000-0000-2222-000000000016', personId: '11111111-1111-1111-2222-000000000018', projectId: '33333333-3333-3333-3333-333333333004', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-116', staffingRole: 'Software Engineer',   status: 'ENDED',     allocationPercent: '60.00', requestedAt: new Date('2025-03-01T00:00:00Z'), approvedAt: new Date('2025-03-03T00:00:00Z'), validFrom: new Date('2025-03-15T00:00:00Z'), validTo: new Date('2026-01-31T00:00:00Z') },

  // REVOKED assignment (on-leave engineer, Isabel Ferreira)
  { id: '36666666-0000-0000-2222-000000000017', personId: '11111111-1111-1111-2222-000000000017', projectId: '33333333-3333-3333-3333-333333333003', requestedByPersonId: '11111111-1111-1111-1111-111111111006', assignmentCode: 'ASN-117', staffingRole: 'Software Engineer',   status: 'REVOKED',   allocationPercent: '50.00', requestedAt: new Date('2025-10-01T00:00:00Z'), approvedAt: new Date('2025-10-03T00:00:00Z'), validFrom: new Date('2025-11-01T00:00:00Z'), validTo: new Date('2026-03-31T00:00:00Z') },

  // Future pipeline (validFrom > today, JTBD-RM3)
  { id: '36666666-0000-0000-2222-000000000018', personId: '11111111-1111-1111-2222-000000000007', projectId: '33333333-3333-3333-2222-000000000002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', assignmentCode: 'ASN-118', staffingRole: 'Frontend Engineer',   status: 'APPROVED',  allocationPercent: '80.00', requestedAt: new Date('2026-04-01T00:00:00Z'), approvedAt: new Date('2026-04-03T00:00:00Z'), validFrom: new Date('2026-06-01T00:00:00Z') },
  ...
  { id: '36666666-0000-0000-2222-000000000019', personId: '11111111-1111-1111-1111-111111111012', projectId: '33333333-3333-3333-3333-333333333001', requestedByPersonId: '11111111-1111-1111-1111-111111111005', assignmentCode: 'ASN-119', staffingRole: 'Bench Consultant',    status: 'ACTIVE',    allocationPercent: '100.00', requestedAt: new Date('2026-01-15T00:00:00Z'), approvedAt: new Date('2026-01-17T00:00:00Z'), validFrom: new Date('2026-02-01T00:00:00Z') },

  // Aisha Musa — on PRJ-105 Polaris (active, 50%)
  { id: '36666666-0000-0000-2222-000000000020', personId: '11111111-1111-1111-2222-000000000011', projectId: '33333333-3333-3333-3333-333333333006', requestedByPersonId: '11111111-1111-1111-1111-111111111007', assignmentCode: 'ASN-120', staffingRole: 'Senior Consultant',   status: 'ACTIVE',    allocationPercent: '50.00', requestedAt: new Date('2026-01-10T00:00:00Z'), approvedAt: new Date('2026-01-12T00:00:00Z'), validFrom: new Date('2026-02-01T00:00:00Z') },

  // Raj Kapoor — pending approval for PRJ-106 Mercury (DRAFT project, REQUESTED)
  { id: '36666666-0000-0000-2222-000000000021', personId: '11111111-1111-1111-2222-000000000016', projectId: '33333333-3333-3333-2222-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', assignmentCode: 'ASN-121', staffingRole: 'Project Coordinator', status: 'REQUESTED', allocationPercent: '100.00', requestedAt: new Date('2026-04-01T00:00:00Z'), validFrom: new Date('2026-05-01T00:00:00Z') },

  // Priya Nair — ops analyst on PRJ-101 (active, supports Director dashboard)
  { id: '36666666-0000-0000-2222-000000000022', personId: '11111111-1111-1111-2222-000000000004', projectId: '33333333-3333-3333-3333-333333333002', requestedByPersonId: '11111111-1111-1111-2222-000000000003', assignmentCode: 'ASN-122', staffingRole: 'Operations Analyst',  status: 'ACTIVE',    allocationPercent: '50.00', requestedAt: new Date('2025-12-01T00:00:00Z'), approvedAt: new Date('2025-12-03T00:00:00Z'), validFrom: new Date('2026-01-01T00:00:00Z') },
];
