...
export const lifeDemoAssignments = [
  ...
  { id: '77000000-0000-0000-0000-000000000001', assignmentCode: 'ASN-NOVA-LR', personId: '11111111-1111-1111-1111-111111111010', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111002', staffingRole: 'Project Manager',      status: 'ACTIVE',    allocationPercent: '20.00', requestedAt: new Date('2025-09-15T00:00:00Z'), approvedAt: new Date('2025-09-17T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000002', assignmentCode: 'ASN-NOVA-EB', personId: '11111111-1111-1111-1111-111111111008', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Lead Engineer',        status: 'ACTIVE',    allocationPercent: '80.00', requestedAt: new Date('2025-09-20T00:00:00Z'), approvedAt: new Date('2025-09-22T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000003', assignmentCode: 'ASN-NOVA-JK', personId: '22222222-0000-0000-0000-000000000001', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Full-Stack Engineer',  status: 'ACTIVE',    allocationPercent: '70.00', requestedAt: new Date('2025-09-20T00:00:00Z'), approvedAt: new Date('2025-09-23T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000004', assignmentCode: 'ASN-NOVA-AT', personId: '22222222-0000-0000-0000-000000000002', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Senior Engineer',      status: 'ACTIVE',    allocationPercent: '60.00', requestedAt: new Date('2025-09-25T00:00:00Z'), approvedAt: new Date('2025-09-27T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000005', assignmentCode: 'ASN-NOVA-MW', personId: '22222222-0000-0000-0000-000000000004', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Backend Engineer',     status: 'ACTIVE',    allocationPercent: '50.00', requestedAt: new Date('2025-09-25T00:00:00Z'), approvedAt: new Date('2025-09-27T00:00:00Z'), validFrom: new Date('2025-10-01T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000006', assignmentCode: 'ASN-NOVA-LM', personId: '22222222-0000-0000-0000-000000000009', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'QA Engineer',           status: 'ACTIVE',    allocationPercent: '60.00', requestedAt: new Date('2025-10-01T00:00:00Z'), approvedAt: new Date('2025-10-03T00:00:00Z'), validFrom: new Date('2025-10-15T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000007', assignmentCode: 'ASN-NOVA-SO', personId: '22222222-0000-0000-0000-000000000010', projectId: '66000000-0000-0000-0000-000000000001', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'PM Support',           status: 'ACTIVE',    allocationPercent: '40.00', requestedAt: new Date('2025-10-01T00:00:00Z'), approvedAt: new Date('2025-10-03T00:00:00Z'), validFrom: new Date('2025-10-15T00:00:00Z') },
  // ── CloudFlex Migration (PRJ-CLOUD-002) — new, some still APPROVED pending start ──
  { id: '77000000-0000-0000-0000-000000000008', assignmentCode: 'ASN-CLOUD-JK', personId: '22222222-0000-0000-0000-000000000001', projectId: '66000000-0000-0000-0000-000000000002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Full-Stack Engineer',  status: 'ACTIVE',   allocationPercent: '60.00', requestedAt: new Date('2026-02-01T00:00:00Z'), approvedAt: new Date('2026-02-05T00:00:00Z'), validFrom: new Date('2026-02-17T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000009', assignmentCode: 'ASN-CLOUD-MP', personId: '22222222-0000-0000-0000-000000000007', projectId: '66000000-0000-0000-0000-000000000002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Business Analyst',    status: 'ACTIVE',   allocationPercent: '80.00', requestedAt: new Date('2026-02-01T00:00:00Z'), approvedAt: new Date('2026-02-05T00:00:00Z'), validFrom: new Date('2026-02-17T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000010', assignmentCode: 'ASN-CLOUD-IR', personId: '22222222-0000-0000-0000-000000000012', projectId: '66000000-0000-0000-0000-000000000002', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Frontend Developer',  status: 'APPROVED', allocationPercent: '20.00', requestedAt: new Date('2026-03-10T00:00:00Z'), approvedAt: new Date('2026-03-12T00:00:00Z'), validFrom: new Date('2026-04-14T00:00:00Z') },
  // ── DataPulse Analytics (PRJ-DATA-003) ────────────────────────────────────
  { id: '77000000-0000-0000-0000-000000000011', assignmentCode: 'ASN-DATA-EB', personId: '11111111-1111-1111-1111-111111111008', projectId: '66000000-0000-0000-0000-000000000003', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Data Platform Engineer', status: 'ACTIVE',  allocationPercent: '40.00', requestedAt: new Date('2025-11-01T00:00:00Z'), approvedAt: new Date('2025-11-03T00:00:00Z'), validFrom: new Date('2025-11-17T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000012', assignmentCode: 'ASN-DATA-PS', personId: '22222222-0000-0000-0000-000000000003', projectId: '66000000-0000-0000-0000-000000000003', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Data Analyst',         status: 'ACTIVE',  allocationPercent: '80.00', requestedAt: new Date('2025-11-01T00:00:00Z'), approvedAt: new Date('2025-11-03T00:00:00Z'), validFrom: new Date('2025-11-17T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000013', assignmentCode: 'ASN-DATA-KN', personId: '22222222-0000-0000-0000-000000000011', projectId: '66000000-0000-0000-0000-000000000003', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Data Engineer',        status: 'ACTIVE',  allocationPercent: '100.00', requestedAt: new Date('2025-11-01T00:00:00Z'), approvedAt: new Date('2025-11-03T00:00:00Z'), validFrom: new Date('2025-11-17T00:00:00Z') },
  // ── MobileFirst Redesign (PRJ-MOB-004) ────────────────────────────────────
  { id: '77000000-0000-0000-0000-000000000014', assignmentCode: 'ASN-MOB-ZA', personId: '22222222-0000-0000-0000-000000000005', projectId: '66000000-0000-0000-0000-000000000004', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Lead UX Designer',     status: 'ACTIVE',  allocationPercent: '100.00', requestedAt: new Date('2025-10-15T00:00:00Z'), approvedAt: new Date('2025-10-17T00:00:00Z'), validFrom: new Date('2025-11-03T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000015', assignmentCode: 'ASN-MOB-IR', personId: '22222222-0000-0000-0000-000000000012', projectId: '66000000-0000-0000-0000-000000000004', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Frontend Developer',  status: 'ACTIVE',  allocationPercent: '80.00', requestedAt: new Date('2025-10-15T00:00:00Z'), approvedAt: new Date('2025-10-17T00:00:00Z'), validFrom: new Date('2025-11-03T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000016', assignmentCode: 'ASN-MOB-DP', personId: '22222222-0000-0000-0000-000000000013', projectId: '66000000-0000-0000-0000-000000000004', requestedByPersonId: '11111111-1111-1111-1111-111111111010', staffingRole: 'Mobile Developer',    status: 'ACTIVE',  allocationPercent: '60.00', requestedAt: new Date('2025-10-15T00:00:00Z'), approvedAt: new Date('2025-10-17T00:00:00Z'), validFrom: new Date('2025-11-03T00:00:00Z') },
  // ── Infrastructure Hardening (PRJ-INFRA-005) ──────────────────────────────
  { id: '77000000-0000-0000-0000-000000000017', assignmentCode: 'ASN-INFRA-TF', personId: '22222222-0000-0000-0000-000000000008', projectId: '66000000-0000-0000-0000-000000000005', requestedByPersonId: '11111111-1111-1111-2222-000000000003', staffingRole: 'Lead Architect',       status: 'ACTIVE',  allocationPercent: '40.00', requestedAt: new Date('2025-12-10T00:00:00Z'), approvedAt: new Date('2025-12-12T00:00:00Z'), validFrom: new Date('2026-01-05T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000018', assignmentCode: 'ASN-INFRA-MW', personId: '22222222-0000-0000-0000-000000000004', projectId: '66000000-0000-0000-0000-000000000005', requestedByPersonId: '11111111-1111-1111-2222-000000000003', staffingRole: 'Backend Engineer',     status: 'ACTIVE',  allocationPercent: '50.00', requestedAt: new Date('2025-12-10T00:00:00Z'), approvedAt: new Date('2025-12-12T00:00:00Z'), validFrom: new Date('2026-01-05T00:00:00Z') },
  { id: '77000000-0000-0000-0000-000000000019', assignmentCode: 'ASN-INFRA-RC', personId: '22222222-0000-0000-0000-000000000006', projectId: '66000000-0000-0000-0000-000000000005', requestedByPersonId: '11111111-1111-1111-2222-000000000003', staffingRole: 'DevOps Engineer',      status: 'ACTIVE',  allocationPercent: '80.00', requestedAt: new Date('2025-12-10T00:00:00Z'), approvedAt: new Date('2025-12-12T00:00:00Z'), validFrom: new Date('2026-01-05T00:00:00Z') },
  // ── Compliance & Audit Prep (PRJ-AUDIT-006) ───────────────────────────────
  { id: '77000000-0000-0000-0000-000000000020', assignmentCode: 'ASN-AUDIT-EG', personId: '11111111-1111-1111-1111-111111111005', projectId: '66000000-0000-0000-0000-000000000006', requestedByPersonId: '11111111-1111-1111-1111-111111111002', staffingRole: 'Compliance Lead',      status: 'ACTIVE',  allocationPercent: '100.00', requestedAt: new Date('2026-01-05T00:00:00Z'), approvedAt: new Date('2026-01-07T00:00:00Z'), validFrom: new Date('2026-01-12T00:00:00Z') },
  // ── Platform Architecture Review (PRJ-ARCH-007) — DRAFT, assignment REQUESTED ──
  { id: '77000000-0000-0000-0000-000000000021', assignmentCode: 'ASN-ARCH-TF', personId: '22222222-0000-0000-0000-000000000008', projectId: '66000000-0000-0000-0000-000000000007', requestedByPersonId: '11111111-1111-1111-1111-111111111002', staffingRole: 'Principal Architect',  status: 'REQUESTED', allocationPercent: '60.00', requestedAt: new Date('2026-04-01T00:00:00Z'), validFrom: new Date('2026-07-01T00:00:00Z') },
  // ── Legacy Decommission (PRJ-LEGACY-008) — winding down ──────────────────
  { id: '77000000-0000-0000-0000-000000000022', assignmentCode: 'ASN-LEGACY-CV', personId: '11111111-1111-1111-2222-000000000003', projectId: '66000000-0000-0000-0000-000000000008', requestedByPersonId: '11111111-1111-1111-1111-111111111002', staffingRole: 'Programme Sponsor',   status: 'ACTIVE',  allocationPercent: '20.00', requestedAt: new Date('2025-03-15T00:00:00Z'), approvedAt: new Date('2025-03-17T00:00:00Z'), validFrom: new Date('2025-04-01T00:00:00Z'), validTo: new Date('2026-04-30T00:00:00Z') },
];
