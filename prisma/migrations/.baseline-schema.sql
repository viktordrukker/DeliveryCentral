...
--
-- Name: DigestSchedule; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: DmEscalationStatus; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."DmEscalationStatus" AS ENUM (
    'PENDING',
    'CONFIRMED',
    'OVERRIDDEN',
    'CANCELLED'
...
--
-- Name: PlannerScenarioStatus; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."PlannerScenarioStatus" AS ENUM (
    'DRAFT',
    'SUBMITTED',
    'APPLIED',
    'CANCELLED'
...
CREATE TABLE public."ProjectPosition" (
    ...
    "requiresOnboardingApproval" boolean DEFAULT false NOT NULL,
    "onboardingApprovedAt" timestamp(3) with time zone,
    "onboardingApprovedByPersonId" uuid
);
...
--
-- Name: dm_escalations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dm_escalations (
    id uuid NOT NULL,
    "publicId" character varying(32),
    ...
    status public."DmEscalationStatus" DEFAULT 'PENDING'::public."DmEscalationStatus" NOT NULL,
...
--
-- Name: person_notification_digest; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.person_skills (
    ...
    "endorsedByPersonId" uuid,
    "endorsedAt" timestamp(3) with time zone,
    "selfEndorsed" boolean DEFAULT false NOT NULL,
...
CREATE TABLE public.planner_scenarios (
    ...
    "publicId" character varying(32),
    "tenantId" uuid,
    status public."PlannerScenarioStatus" DEFAULT 'DRAFT'::public."PlannerScenarioStatus" NOT NULL,
    "updatedByPersonId" uuid
);
...
CREATE TABLE public.rate_card_entries (
    ...
    "createdByPersonId" uuid,
    "updatedByPersonId" uuid,
    "pinnedPositions" jsonb DEFAULT '[]'::jsonb NOT NULL
);
...
--
-- Name: dm_escalations dm_escalations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dm_escalations
    ADD CONSTRAINT dm_escalations_pkey PRIMARY KEY (id);
...
--
-- Name: person_notification_digest person_notification_digest_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ProjectPositionCandidate_legacyCandidateId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ProjectPositionCandidate_legacyCandidateId_idx" ON public."ProjectPositionCandidate" USING btree ("legacyCandidateId");
...
--
-- Name: ProjectPosition_onboardingApprovedByPerson_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ProjectPosition_onboardingApprovedByPerson_idx" ON public."ProjectPosition" USING btree ("onboardingApprovedByPersonId");
...
--
-- Name: dm_escalations_escalatedByPersonId_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "dm_escalations_escalatedByPersonId_status_idx" ON public.dm_escalations USING btree ("escalatedByPersonId", status);


--
-- Name: dm_escalations_escalatedToPersonId_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "dm_escalations_escalatedToPersonId_status_idx" ON public.dm_escalations USING btree ("escalatedToPersonId", status);


--
-- Name: dm_escalations_publicId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "dm_escalations_publicId_key" ON public.dm_escalations USING btree ("publicId");


--
-- Name: dm_escalations_resolvedByPersonId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "dm_escalations_resolvedByPersonId_idx" ON public.dm_escalations USING btree ("resolvedByPersonId");


--
-- Name: dm_escalations_status_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "dm_escalations_status_createdAt_idx" ON public.dm_escalations USING btree (status, "createdAt");
...
--
-- Name: leave_policies_createdByPersonId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "leave_policies_createdByPersonId_idx" ON public.leave_policies USING btree ("createdByPersonId");


--
-- Name: leave_policies_leaveType_active_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "leave_policies_leaveType_active_idx" ON public.leave_policies USING btree ("leaveType", active);


--
-- Name: leave_policies_publicId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "leave_policies_publicId_key" ON public.leave_policies USING btree ("publicId");


--
-- Name: leave_policies_updatedByPersonId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "leave_policies_updatedByPersonId_idx" ON public.leave_policies USING btree ("updatedByPersonId");
...
--
-- Name: person_skills_endorsedByPerson_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "person_skills_endorsedByPerson_idx" ON public.person_skills USING btree ("endorsedByPersonId");
...
--
-- Name: planner_scenarios_publicId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "planner_scenarios_publicId_key" ON public.planner_scenarios USING btree ("publicId");


--
-- Name: planner_scenarios_tenantId_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "planner_scenarios_tenantId_status_idx" ON public.planner_scenarios USING btree ("tenantId", status);


--
-- Name: planner_scenarios_updatedByPersonId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "planner_scenarios_updatedByPersonId_idx" ON public.planner_scenarios USING btree ("updatedByPersonId");
...
--
-- Name: project_milestones_workstreamId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: timesheet_entries_personId_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "timesheet_entries_personId_date_idx" ON public.timesheet_entries USING btree ("personId", date);


--
-- Name: timesheet_entries_positionId_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "timesheet_entries_positionId_date_idx" ON public.timesheet_entries USING btree ("positionId", date);
...
--
-- Name: ProjectPosition ProjectPosition_onboardingApprovedByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProjectPosition"
    ADD CONSTRAINT "ProjectPosition_onboardingApprovedByPersonId_fkey" FOREIGN KEY ("onboardingApprovedByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: dm_escalations dm_escalations_escalatedByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dm_escalations
    ADD CONSTRAINT "dm_escalations_escalatedByPersonId_fkey" FOREIGN KEY ("escalatedByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: dm_escalations dm_escalations_escalatedToPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dm_escalations
    ADD CONSTRAINT "dm_escalations_escalatedToPersonId_fkey" FOREIGN KEY ("escalatedToPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: dm_escalations dm_escalations_resolvedByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dm_escalations
    ADD CONSTRAINT "dm_escalations_resolvedByPersonId_fkey" FOREIGN KEY ("resolvedByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: leave_policies leave_policies_createdByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.leave_policies
    ADD CONSTRAINT "leave_policies_createdByPersonId_fkey" FOREIGN KEY ("createdByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: leave_policies leave_policies_updatedByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.leave_policies
    ADD CONSTRAINT "leave_policies_updatedByPersonId_fkey" FOREIGN KEY ("updatedByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: person_notification_digest person_notification_digest_personId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: person_skills person_skills_endorsedByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.person_skills
    ADD CONSTRAINT "person_skills_endorsedByPersonId_fkey" FOREIGN KEY ("endorsedByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: planner_scenarios planner_scenarios_tenantId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.planner_scenarios
    ADD CONSTRAINT "planner_scenarios_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES public."Tenant"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: planner_scenarios planner_scenarios_updatedByPersonId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.planner_scenarios
    ADD CONSTRAINT "planner_scenarios_updatedByPersonId_fkey" FOREIGN KEY ("updatedByPersonId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: project_milestones project_milestones_workstreamId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timesheet_entries timesheet_entries_personId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.timesheet_entries
    ADD CONSTRAINT "timesheet_entries_personId_fkey" FOREIGN KEY ("personId") REFERENCES public."Person"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: timesheet_entries timesheet_entries_positionId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.timesheet_entries
    ADD CONSTRAINT "timesheet_entries_positionId_fkey" FOREIGN KEY ("positionId") REFERENCES public."ProjectPosition"(id) ON UPDATE CASCADE ON DELETE SET NULL;
